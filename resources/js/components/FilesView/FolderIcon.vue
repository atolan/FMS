<template>
    <div :class="[{'is-apple': $isApple()}, location]">
        ...
        <span class="file-icon-text">
            ...
            >
                <svg v-if="folderItems === 0" width="80px" height="80px" viewBox="0 0 512 512" fill="none" :style="{stroke: color}" :class="[{'default-color' : ! color}]" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="folder" role="img" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg v-if="folderItems !== 0" width="80px" height="80px" viewBox="0 0 512 512" fill="none" :style="{stroke: color}" :class="[{'default-color' : ! color}]">
