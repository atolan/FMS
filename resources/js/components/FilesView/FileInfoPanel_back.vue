<template>
    <div class="modal-mask file-info-content">
        <div class="modal-container">
            <div class="modal-title">
                <b>Preview</b>
                <button type="button" @click="closeInfo" class="close" label="Close">
            ...
            <div class="file-headline" spellcheck="false">
                ...
                <div class="file-info fileDetail">
                    ...
                    <div class="file-info previewBtns">
                        <div class="file-info-button row" >
                            <button class="button" @click="addToPage" type="button" id="addtoPage" data-dismiss="modal" aria-hidden="true">Add to Page</button>
                            <button class="button" @click="renameItem" type="button" id="rename" aria-hidden="true">Rename</button>
                            <button class="button" @click="deleteItem" type="button" id="delete" aria-hidden="true">Delete</button>
                            <button class="button" @click="downloadItem" type="button" id="download" aria-hidden="true">Download</button>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['fileInfoPreview', 'permissionOptions', 'data']),
            fileType() {
        ...
        methods: {
            addToPage(){
                const _data = [{type: this.fileInfoPreview[0].type, name: this.fileInfoPreview[0].name, basename: this.fileInfoPreview[0].basename}];
            ...
            deleteItem(){
                ...
                this.$store.dispatch("deleteItem", this.fileInfoPreview[0])
                this.$store.commit('CLEAR_FILEINFO_PREV')
            },
            downloadItem(){
