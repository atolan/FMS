...
export default {
    ...
    computed: {
        ...mapGetters(['FilePreviewType', 'fileInfoDetail', 'fileInfoPreview',  'copyOrCutInfo', 'clipBoard',  'data', 'focusNameID']),
        isClicked() {
        ...
        clickedItem(e) {
            ...
            if (!this.$isMobile()) {
                ...
                if (this.item.type === 'folder')
                    events.$emit('leftMenu:show', this.item)
