...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['fileInfoDetail','curclickedItem', 'data', 'user', 'treefolders']),
        ...
        methods: {
            ...
            dragFinish(evt) {
                ...
                // if(this.fileInfoDetail.includes(this.draggedItem)) {
                    ...
                    if (folder_id !== this.nodes.unique_id && parseInt(this.fileInfoDetail[0].unique_id) !== this.nodes.unique_id)
