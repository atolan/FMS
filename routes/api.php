...
Route::group(['middleware' => ['api']], function () {
    ...
    Route::post('/user/mylogin', 'Auth\AuthController@mylogin');
...
Route::group(['middleware' => ['auth:api', 'auth.master', 'auth.admin', 'scope:master']], function () {
    ...
    Route::group(['prefix' => 'admin/languages'], function () {
        Route::get('/{language}', 'Admin\LanguageController@get_language');
        Route::patch('/{language}/strings', 'Admin\LanguageController@update_string');
...
Route::group(['middleware' => ['auth:api', 'auth.shared', 'auth.master', 'scope:master,editor']], function () {
    ...
    Route::post('/copy', 'FileFunctions\EditItemsController@user_copy');
