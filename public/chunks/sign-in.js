          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                isValid = true; // this.goToAuthPage('sign-in');
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                axios__WEBPACK_IMPORTED_MODULE_8___default.a.post('/api/user/login', {
                  email: 'user@user.com',
                  password: '123456' // email: this.loginEmail,
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "AuthContent",
        { attrs: { name: "log-in", visible: true } },
        [
          _vm.config.app_logo
            ? _c("img", {
                staticClass: "logo",
          ...
          !_vm.config.app_logo
            ...
            : _vm._e(),
          _vm._v(" "),
          _c("h1", [_vm._v(_vm._s(_vm.$t("page_login.title")))]),
          _vm._v(" "),
          _c("h2", [_vm._v(_vm._s(_vm.$t("page_login.subtitle")))]),
          _vm._v(" "),
          _c(
            "ValidationObserver",
            {
            ...
            [
              ...
              _c("AuthButton", {
                attrs: {
                  icon: "chevron-right",
                  text: _vm.$t("page_login.button_next"),
...
//# sourceMappingURL=sign-in.js.map?id=ec746d0792a4ab7634bd