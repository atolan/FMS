...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'ContentSidebar',
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])(['currentFolder', 'data'])),
  methods: {
    contextMenu: function contextMenu(event, item) {
      this.data['focusedParentFolderIndex'] = 0;
      _bus__WEBPACK_IMPORTED_MODULE_1__["events"].$emit('contextMenu:show', event, item, true);
    },
    dropUpload: function dropUpload(event) {
      if (this.data['IsExternalUploadedToTreeMenu'] === undefined) {
        this.data['IsExternalUploadedToTreeMenu'] = false;
      }

      if (this.data['IsExternalUploadedToTreeMenu']) return;
      this.$uploadExternalFiles(event, 0);
    }
  },
  mounted: function mounted() {
    var contentsidebar = this.$refs.contentsidebar;
...
var render = function() {
  ...
  return _c(
    ...
    {
      ref: "contentsidebar",
      staticClass: "content-sidebar",
      attrs: { id: "content-sidebar" },
      on: {
        drop: function($event) {
...
//# sourceMappingURL=shared-page.js.map?id=5a1461db279043d09f8f